...
namespace IndieGameZone.Infrastructure.Repositories
{
    internal sealed class CommercialPackageRepository : RepositoryBase<CommercialPackages>, ICommercialPackageRepository
    {
        ...
        public async Task<CommercialPackages?> GetCommercialPackageById(Guid id, bool trackChange, CancellationToken ct = default) => await FindByCondition(c => c.Id.Equals(id), trackChange)
        ...
        {
            var commercialPackageEntities = FindAll(trackChange)
                .Sort();
