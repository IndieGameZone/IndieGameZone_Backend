	...
	public class CategoryConfiguration : IEntityTypeConfiguration<Categories>
	{
		public void Configure(EntityTypeBuilder<Categories> builder)
		{
			...
			builder.HasData(
				...
				new Categories { Id = Guid.Parse("3ef51667-ff8d-4873-979b-a3b9a5dbe1b1"), Name = "Horror" },
				...
				new Categories { Id = Guid.Parse("fcb43570-6859-41f4-8d72-ce59a31f5858"), Name = "Stealth" },
				new Categories { Id = Guid.Parse("dcf41a71-dd69-43db-af34-a8ca8592b079"), Name = "Open World" },
				new Categories { Id = Guid.Parse("ab34908d-20dc-43bd-b80d-eac5b59d6238"), Name = "Survival" },
				new Categories { Id = Guid.Parse("592e7334-c896-46f6-ad6c-a781a2ab7219"), Name = "BoardGame" }
